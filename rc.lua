...
if awesome.startup_errors then
    naughty.notify({ preset = naughty.config.presets.critical,
                     title = "Oops, ha ocurrido un error al momento de inciar.",
...
local browser1          = "googlee-chrome-stable"
...
awful.util.mymainmenu = freedesktop.menu.build({
    ...
    after = {
        { "Terminal", terminal },
        { "Cerrar sesión", function() awesome.quit() end },
...
globalkeys = my_table.join(
    ...
    function ()
        awful.spawn(string.format("dmenu_run -i -nb '#2C0C23' -nf '#F72585' -sb '#F72585' -sf '#2C0C23' -fn NotoMonoRegular:bold:pixelsize=14",
    ...
    awful.key({ modkey, "Shift" }, "t", function () awful.util.spawn( "rofi-theme-selector" ) end,
    ...
    -- screenshots
    --awful.key({ }, "Print", function () awful.util.spawn("scrot 'XDN-%Y-%m-%d-%s_screenshot_$wx$h.jpg' -e 'mv $f $$(xdg-user-dir PICTURES)'") end,
 ...
 -- Show/Hide Systray
    ...
    -- Brightness
    awful.key({ }, "XF86MonBrightnessUp", function () os.execute("brightlight -i 390") end,
              {description = "+5%", group = "hotkeys"}),
    awful.key({ }, "XF86MonBrightnessDown", function () os.execute("brightlight -d 390") end,
              {description = "-5%", group = "hotkeys"}),
...
awful.spawn.with_shell("picom -b --config  $HOME/.config/awesome/configuration/picom.conf")
